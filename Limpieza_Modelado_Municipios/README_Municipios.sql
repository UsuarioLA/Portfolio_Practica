...
- Crear nuevas tablas relacionadas
- Estructurar un modelo de datos más eficiente
...
### 🔹 Análisis con SQL
- Conteo de municipios por provincia
- Análisis de categorías
- Uso de funciones (ABS, CAST, FLOOR)
- Uso de JOINs (LEFT, RIGHT, INNER)
...
## 📊 Resultados
Se logró transformar un dataset desordenado en una estructura relacional más limpia y preparada para análisis.
